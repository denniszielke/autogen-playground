...
async def main() -> None:
    ...
    inner_team = RoundRobinGroupChat([users_agent, location_agent, time_agent], termination_condition=inner_termination)

    society_of_mind_agent = SocietyOfMindAgent("society_of_mind", team=inner_team, model_client=az_model_client)
    ...
    group_chat = RoundRobinGroupChat(
        [society_of_mind_agent, summary_agent], termination_condition=termination
    )
